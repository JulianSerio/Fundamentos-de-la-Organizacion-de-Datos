...
begin
	...
	while (regDet.cod <> VALOR_ALTO) do begin
		reset(maestro);
		leerMaestro(maestro,regMae); //leo maestro
		while (regMae.cod <> VALOR_ALTO) do begin //si no llegue al final
			if (regMae.cod = regDet.cod) then begin //si el codigo coincide
